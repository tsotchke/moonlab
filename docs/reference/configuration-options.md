...
| `MOONLAB_SIMD_FORCE_BASELINE`     | `src/optimization/simd_dispatch.c` | when `1`, `true`, or `yes`, disable AVX-512 dispatch for portability diagnosis; it does not alter detected capability flags. |
