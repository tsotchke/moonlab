import{r as i,j as t}from"./index-B-zibKa4.js";import{e as j,r as v}from"./moonlabClient-D-rb-4O8.js";const l=[{id:"bell-state",title:"Bell State (Entanglement)",description:"Create a maximally entangled Bell state |Φ+⟩ = (|00⟩ + |11⟩)/√2",code:`import { QuantumState } from '@moonlab/quantum-core';
...
vqe.dispose();`,runnable:!1}],E=()=>{const[c,h]=i.useState(l[0].id),[g,u]=i.useState(!1),[q,x]=i.useState({}),[d,m]=i.useState({}),[p,b]=i.useState(null),a=l.find(e=>e.id===c)||l[0],y=(e,s)=>{const o=[];for(let n=0;n<e.length;n++){const r=e[n];if(r<5e-4)continue;const C=n.toString(2).padStart(s,"0");o.push(`|${C}⟩: ${(r*100).toFixed(2)}%`)}return o.length===0?"No non-zero probabilities found.":o.join(`
`)},f=async()=>{if(a.runnable){b(a.id),m(e=>({...e,[a.id]:""}));try{await j();let e=0,s=[];if(a.id==="bell-state"?(e=2,s=[{type:"H",qubit:0},{type:"CNOT",qubit:1,controlQubit:0}]):a.id==="superposition"?(e=3,s=[{type:"H",qubit:0},{type:"H",qubit:1},{type:"H",qubit:2}]):a.id==="phase-kickback"&&(e=2,s=[{type:"H",qubit:0},{type:"X",qubit:1},{type:"CZ",qubit:1,controlQubit:0},{type:"H",qubit:0}]),e===0)throw new Error("Example is not runnable in the browser build.");const o=await v({numQubits:e,gates:s});o.warnings.length&&console.warn("Example warnings:",o.warnings);const n=y(o.probabilities,e);x(r=>({...r,[a.id]:n}))}catch(e){m(s=>({...s,[a.id]:e instanceof Error?e.message:String(e)}))}finally{b(null)}}},S=async()=>{await navigator.clipboard.writeText(a.code),u(!0),setTimeout(()=>u(!1),2e3)};return t.jsxs("div",{className:"examples",children:[t.jsxs("div",{className:"section-header",children:[t.jsx("h1",{className:"section-title",children:"Code Examples"}),t.jsx("p",{className:"section-description",children:"Copy-paste code snippets to get started quickly with quantum computing."})]}),t.jsxs("div",{className:"examples-layout",children:[t.jsx("aside",{className:"examples-sidebar",children:l.map(e=>t.jsxs("button",{className:`example-btn ${c===e.id?"selected":""}`,onClick:()=>h(e.id),children:[t.jsx("span",{className:"example-title",children:e.title}),t.jsx("span",{className:"example-desc",children:e.description})]},e.id))}),t.jsxs("main",{className:"example-content",children:[t.jsxs("div",{className:"example-header",children:[t.jsx("h2",{children:a.title}),t.jsxs("div",{className:"example-actions",children:[a.runnable&&t.jsx("button",{className:"btn btn-primary",onClick:f,disabled:p===a.id,children:p===a.id?"Running…":"Run Example"}),t.jsx("button",{className:"btn btn-secondary",onClick:S,children:g?"Copied!":"Copy Code"})]})]}),t.jsx("p",{className:"example-description",children:a.description}),t.jsx("div",{className:"code-container",children:t.jsx("pre",{className:"code-block",children:t.jsx("code",{children:a.code})})}),t.jsxs("div",{className:"output-container",children:[t.jsx("h3",{children:"Output"}),a.runnable?t.jsx("pre",{className:"output-block",children:d[a.id]?`Error: ${d[a.id]}`:q[a.id]||"Run the example to compute output in WASM."}):t.jsx("pre",{className:"output-block",children:"This example depends on algorithms not bundled in the browser WASM build yet."})]})]})]})]})};export{E as default};
//# sourceMappingURL=Examples-DoKt50Wd.js.map
