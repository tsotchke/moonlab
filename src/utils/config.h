...
/* The version macros (MOONLAB_VERSION_STRING, MOONLAB_VERSION_MAJOR /
 * MINOR / PATCH) used to live here as hand-edited constants and drifted
 * out of sync with VERSION.txt.  They are now generated by CMake from
 * VERSION.txt into `moonlab_build_info.h`; include that header to use
 * them.  Do not redefine the macros in this file -- the duplicates
 * would shadow the generated values silently and break manifest /
 * test_manifest version checks. */
